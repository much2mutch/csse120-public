...
def main():
    ...
    even_better_draw_circles(rg.Point(100,50),15,10,"red",4)
    even_better_draw_circles(rg.Point(-100,-50),35,7,"blue",5)
    even_better_draw_circles(rg.Point(200,-250),50,13,"green",10)
    window.update()
...
def even_better_draw_circles(point, radii,circles,color,thickness):
    """
    Starts out the same as the   draw_circles   function defined ABOVE.
    You will make it an IMPROVED, MORE POWERFUL function per the above _TODO_.
    """

...
###############################################################################
#    LowerLevelTouchSensor
###############################################################################
class LowLevelTouchSensor(object):
    """
...
###############################################################################
#    LowerLevelColorSensor
###############################################################################
class LowerLevelColorSensor(object):
...
###############################################################################
#    LowerLevelInfraredProximitySensor
###############################################################################
...
###############################################################################
#    LowerLevelInfraredBeaconSensor
###############################################################################
...
class LowerLevelLed(object):
    ...
    def set_color(self, color_name, percent_intensity=100):
        """
        Sets this Led to the given color at the given intensity.
        Valid colors are:
          "red", "green", "amber", "off"
        :type color_name: str
        """

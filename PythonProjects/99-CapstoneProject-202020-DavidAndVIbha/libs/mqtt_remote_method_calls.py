...
class MqttClient(object):
    """
    Helper class to make it easier to work with
    MQTT subscriptions and publications, specific to our Snatch3r robots.
    """

    def __init__(self, delegate=None):
        """
        Constructs the MQTT client and optionally connects a delegate
        object for message Rx.
    ...
    def send_message(self, function_name, parameter_list=None):
        ...
        print("sent", self.publish_topic_name, message)

...
class Point(object):
    ...
    def move_to(self, x, y):
        self.travelled = self.travelled + self.get_distance_from(Point(x,y))
        self.x = x
        self.y = y
        self.moves = self.moves + 1

    def move_by(self, x, y):
        self.travelled = self.travelled + self.get_distance_from(Point(self.x+x,self.y+y))
        self.x = self.x + x
        self.y = self.y + y
        self.moves = self.moves + 1
...
def run_test_get_distance_traveled():
    ...
    """
    # -------------------------------------------------------------------------
    # TODONEDO: 11.  Follow the same instructions as in _TODO_3 above,
    ...
    p1 = Point(10,0)
    p1.move_to(20,0)
    print("expected 10, actual ",p1.get_distance_traveled())

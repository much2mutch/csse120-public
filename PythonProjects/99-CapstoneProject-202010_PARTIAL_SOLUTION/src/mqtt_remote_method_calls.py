...
class MqttClient(object):
    ...
    def connect_to_mqtt_to_talk_to_robot(self,
        ...
        self.connect("msg4pc", "msg4ev3",
                         self.mqtt_broker_ip_address, lego_robot_number)
    ...
    def connect(self, subscription_suffix, publish_suffix,
        ...
        if lego_robot_number is None:
            print("NOT connecting, since robot number is None.")
            print("  If you want to connect, put your robot number")
            print("  m0_set_robot_number and retry.")
            return
        elif mqtt_broker_ip_address is None:

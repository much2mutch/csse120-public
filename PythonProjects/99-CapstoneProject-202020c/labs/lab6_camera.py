...
def run_test_blob_readings(robot):
    ...
    while True:
        time.sleep(1.0)
        # -------------------------------------------------------------------------
        # TODO: 3. Use the  get_biggest_blob  method of the  camera
...
def run_test_spin_until_color_seen(robot):
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        # TODO: 4. Call the  spin_until_color_seen  method of the   camera_tracker
...
def run_test_spin_to_track_color(robot):
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        # TODO: 5. Call the  spin_to_track_beacon  method of the  beacon_seeker
